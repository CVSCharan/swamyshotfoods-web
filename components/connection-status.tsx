...
export function ConnectionStatus() {
  ...
  // Only show when:
  // 1. We've connected at least once (not first load)
  // 2. Currently disconnected
  // 3. We have initial data (so user isn't waiting for first load)
  const shouldShow = hasConnectedOnce && !isConnected && config !== null;
